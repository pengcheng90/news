 ...
 */
public class TopViewMyAdapter extends RecyclerView.Adapter<TopViewMyAdapter.MyViewHolder> implements View.OnClickListener{

    private List<TopViewBean.ResultBean.DataBean> data;
    private Activity activity;
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;
    //define interface
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view , TopViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(TopViewBean.ResultBean.DataBean)view.getTag());
        }
    }
    ...
    public TopViewMyAdapter(List<TopViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
