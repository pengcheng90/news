 ...
 */
public class CommunityViewMyAdapter extends RecyclerView.Adapter<CommunityViewMyAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, CommunityViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(CommunityViewBean.ResultBean.DataBean) view.getTag());
        }
    }
    ...
    public CommunityViewMyAdapter(List<CommunityViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
