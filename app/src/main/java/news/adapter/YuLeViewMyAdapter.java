 ...
 */
public class YuLeViewMyAdapter extends RecyclerView.Adapter<YuLeViewMyAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, YuLeViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(YuLeViewBean.ResultBean.DataBean)view.getTag());
        }
    }
    ...
    public YuLeViewMyAdapter(List<YuLeViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
