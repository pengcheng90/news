 ...
 */
public class GuoNeiViewMyAdapter extends RecyclerView.Adapter<GuoNeiViewMyAdapter.MyViewHolder> implements View.OnClickListener{

    private List<GuoNeiViewBean.ResultBean.DataBean> data;
    private Activity activity;
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;
    //define interface
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, GuoNeiViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(GuoNeiViewBean.ResultBean.DataBean) view.getTag());
        }
    }
    ...
    public GuoNeiViewMyAdapter(List<GuoNeiViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
