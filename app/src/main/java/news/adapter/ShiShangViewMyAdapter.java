 ...
 */
public class ShiShangViewMyAdapter extends RecyclerView.Adapter<ShiShangViewMyAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, ShiShangViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(ShiShangViewBean.ResultBean.DataBean)view.getTag());
        }
    }
    ...
    public ShiShangViewMyAdapter(List<ShiShangViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
