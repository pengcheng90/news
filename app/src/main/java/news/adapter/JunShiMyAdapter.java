 ...
 */
public class JunShiMyAdapter extends RecyclerView.Adapter<JunShiMyAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, JunShiBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view, (JunShiBean.ResultBean.DataBean) view.getTag());
        }
    }
    ...
    public JunShiMyAdapter(List<JunShiBean.ResultBean.DataBean> data, Activity activity) {
        this.data = data;
