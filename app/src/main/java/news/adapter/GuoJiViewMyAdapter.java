 ...
 */
public class GuoJiViewMyAdapter extends RecyclerView.Adapter<GuoJiViewMyAdapter.MyViewHolder> implements View.OnClickListener{

    private List<GuoJiViewBean.ResultBean.DataBean> data;
    private Activity activity;
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;
    //define interface
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, GuoJiViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(GuoJiViewBean.ResultBean.DataBean) view.getTag());
        }
    }
    ...
    public GuoJiViewMyAdapter(List<GuoJiViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
