 ...
 */
public class TiYuViewMyAdapter extends RecyclerView.Adapter<TiYuViewMyAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, TiYuViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view, (TiYuViewBean.ResultBean.DataBean) view.getTag());
        }
    }
    ...
    public TiYuViewMyAdapter(List<TiYuViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data = data;
