 ...
 */
public class KeJiViewMyAdapter extends RecyclerView.Adapter<KeJiViewMyAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, KeJiViewBean.ResultBean.DataBean data);
    }
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(view,(KeJiViewBean.ResultBean.DataBean)view.getTag());
        }
    }
    ...
    public KeJiViewMyAdapter(List<KeJiViewBean.ResultBean.DataBean> data, Activity activity) {
        this.data=data;
